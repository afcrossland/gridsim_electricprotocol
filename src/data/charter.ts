...
export const CHARTER = {
  ...
  intro: [
    "People and communities will play an increasingly critical role in how energy is produced, managed, and shared because distributed, consumer-sited energy resources like solar, EVs and batteries now complement supply from utility scale resources.",
    "The lowest cost energy solution will come from a level playing field for all energy resources, of all sizes, competing equally to deliver electricity and grid services on grid. To ensure equitable transition of this behind the meter technology, the right policies are needed that remove unnecessary barriers and support local action.",
    "This Charter sets out clear principles to guide regulation and market design to ensure a level playing field for all assets. It is about choice, fairness, and ensuring the lowest overall cost of energy delivery - and recognises that people will be at the heart of the energy transition.",
  ],
