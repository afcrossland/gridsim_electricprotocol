// Moved into shared/ 2026-09-19, per Andrew's own instruction ("the
// MUI-theme... should be common now") - previously duplicated three times
// (root src/, deployment/src/, calculator/src/), confirmed via a
// comment-stripped diff to be functionally identical in every app
// (same palette/typography/component-override values, deployment's and
// calculator's own copies just had far less inline commentary, and their
// own doc comments already said they were "ported from
// ep_policymap/src/mui-theme.tsx's getTheme(mode)... port changes back
// the same way if that file's own getTheme ever changes"). This is that
// file, kept as the canonical single copy from here on - `customMixins`
// below is unused anywhere in the repo today, kept for parity rather than
// dropped as part of this move.
